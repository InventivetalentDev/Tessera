 ...
 * bundled file produced by {@link BakeMain} (block-key form: {@link io.tessera.core.BlockKey})
 * and the runtime cache file managed by {@link RuntimeHeadsStore} (block-key
 * form: {@link io.tessera.core.BakeKey}). The schema is identical between the
